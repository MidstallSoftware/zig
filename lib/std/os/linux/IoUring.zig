...
pub fn setup_buf_ring(fd: os.fd_t, entries: u16, group_id: u16) !*linux.io_uring_buf_ring {
    ...
    const br: *linux.io_uring_buf_ring = @ptrCast(mem.alignPointer(mmap.ptr, std.hea.pageSize()) orelse unreachable);
...
pub fn free_buf_ring(fd: os.fd_t, br: *linux.io_uring_buf_ring, entries: u32, group_id: u16) void {
