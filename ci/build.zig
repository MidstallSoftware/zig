...
pub fn build(b: *std.Build) void {
    ...
    run_exe.step.max_rss = 276_529_152;
    ...
    const run_chmod_step = if (host_target.result.isDarwin()) steps: {
        ...
        chmod_exe.step.max_rss = 254_050_304;
    ...
    const build_cc_stage2_step = if (b.option(
        ...
        build_bootstrap.step.max_rss = 93_835_264;
        ...
        build_stage3.step.max_rss = 539_484_160;
...

    {
        ...
        for (b.option([]const []const u8, "extra-target", "Extra targets to build") orelse &.{}) |build_target| {
            ...
            build_stage4.step.max_rss = 4_369_842_176;
...

        {
            ...
            run_tidy.step.max_rss = 11_943_936;
        ...
        switch (build_type) {
            ...
            .Release, .RelWithDebInfo, .MinSizeRel => {
                ...
                build_stage4.step.max_rss = 4_267_229_184;
                build_stage4.addArgs(&.{
                    "$2",
                    "build",
                    "$--maxrss",
                ...
                run_cmp.step.max_rss = 4_698_112;
        ...
        if (binaryen_lazy_dep) |binaryen_dep| {
            ...
            update_zig1.step.max_rss = 1_672_757_248;
            ...
            build_updated_stage4.step.max_rss = 4_244_979_712;
            ...
            run_tests_with_updated_stage4.step.max_rss = 613_875_712;
        ...
        msvc: {
            ...
            build_msvc_compiler_rt.step.max_rss = 173_846_528;
            ...
            build_msvc_tests.step.max_rss = 556_036_096;
            ...
            run_msvc_tests.step.max_rss = 6_459_392;
